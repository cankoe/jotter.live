...
let checkboxToggleCallback;
export function setCheckboxToggleCallback(callback) {
    checkboxToggleCallback = callback;
}
// Widget for checkboxes
class CheckboxWidget extends WidgetType {
    constructor(checked, pos, onToggle) {
        super();
